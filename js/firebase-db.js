...
const FirebaseDB = {
  ...
  async exportAll() {
    const storeNames = ['users', 'taxInvoiceRequests', 'deposits', 'transferRecords', 'matchingLog', 'auditLog', 'documents', 'checklists', 'leaveRequests', 'leaveBalances', 'appSettings', 'outsourcingProjects', 'contracts', 'purchaseInvoices', 'settlements', 'expenseReports'];
    const data = {};
