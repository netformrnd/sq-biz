  ...
  GUIDES: {
      ...
      sections: [
        {
          ...
          body: `
            <ol>
              <li>사이드바 → <strong>프로젝트 관리 → 대림프로젝트 정산관리</strong></li>
            ...
            <ol>
              ...
              <li>입력 항목:
                <ul>
                  ...
                  <li><strong>프로젝트</strong> = 대림프로젝트 정산관리의 프로젝트명과 <strong style="color:#dc2626;">정확히 동일하게</strong> 입력</li>
                </ul>
              </li>
              <li><strong>[등록]</strong> 클릭</li>
            </ol>
        ...
        },
        {
          ...
          body: `
            <dl>
              <dt>🔹 "집행금액이 0원으로 나옴"</dt>
              <dd>송금내역과 대림프로젝트 정산관리의 프로젝트명이 정확히 일치 안 함<br>
              → 대림프로젝트 정산관리의 프로젝트명 복사 → 송금내역에 붙여넣기</dd>
              ...
              <dd>대림프로젝트 정산관리 [📥 엑셀 양식 다운로드] → 양식 채워서 [📤 엑셀 일괄 업로드]</dd>
            </dl>
          `
        }
      ]
      ...
      sections: [
        {
          ...
          body: `
            <ol>
              <li>사이드바 → <strong>프로젝트 관리 → 아파트 스퀘어 수금 관리</strong></li>
        ...
        },
        {
          ...
          body: `
            <ol>
              ...
              <li>등록 → <strong>아파트 스퀘어 수금 관리에 자동 반영</strong></li>
            </ol>
          `
        },
        {
          ...
          body: `
            <ol>
              ...
              <li>매칭되면 → 아파트 스퀘어 수금 관리에 <strong>입금일 자동 표시 ✅</strong></li>
            </ol>
    ...
    transfers: {
      ...
      sections: [
            ...
            <ol>
              ...
              <li>입력 항목:
                <ul>
                  <li>송금일 / 수취인 / 금액</li>
                  <li>용도 (용역비, 외주비 등)</li>
                  <li><strong>프로젝트명</strong> (대림프로젝트 정산관리 매칭용 — 정확히 동일하게 입력)</li>
                </ul>
              </li>
            </ol>
          `
        ...
        {
          heading: '[2] 대림프로젝트 정산관리와 자동 매칭',
          body: `
            <p>송금의 <strong>프로젝트명</strong>이 대림프로젝트 정산관리의 프로젝트명과 정확히 일치하면:</p>
            <ul>
              <li>대림프로젝트 정산관리의 <strong>"집행금액"</strong>이 자동 합산</li>
            ...
            <ol>
              ...
              <li>입력 항목:
                <ul>
                  ...
                  <li>프로젝트명</li>
                  <li><strong>📋 계약 연결</strong> (선택): 신규/기존 계약 선택 → 자동으로 아파트 스퀘어 수금 관리에 반영</li>
  ...
  render(focusKey) {
    ...
    this.container.innerHTML = `
      ...
      <div class="no-print" style="margin-top:var(--sp-4);padding:var(--sp-3);background:var(--color-bg-light);border-radius:var(--radius-sm);font-size:var(--font-size-sm);color:var(--color-text-muted);">
        💡 <strong>도움말</strong>: 각 페이지(대림프로젝트 정산관리, 아파트 스퀘어 수금 관리 등)에서 우측 상단 <strong>[📖 도움말]</strong> 버튼을 클릭하면 해당 페이지 전용 가이드만 빠르게 볼 수 있습니다.
      </div>
    `;
